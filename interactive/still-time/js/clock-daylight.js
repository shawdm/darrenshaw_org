new p5((p) => {
    ...
    p.draw = () => {
        ...
        p.cursor(dawnHovered || duskHovered ? 'pointer' : 'default');
        ...
        ClockCommon.drawClockHand(p, layout, dayHandEnd, ClockCommon.PRIMARY_COLOR);
